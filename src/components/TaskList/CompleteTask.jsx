...
const CompleteTask = ({ data }) => {
  return (
    <div className='rounded-[1.75rem] border border-emerald-500/20 bg-slate-950/95 p-6 shadow-lg shadow-slate-950/20'>
      <div className='flex items-center justify-between gap-3'>
        <span className='rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-300'>Completed</span>
